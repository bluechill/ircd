...
PLUGINS=plugins/names-plugin.plugin plugins/join-plugin.plugin plugins/quit-plugin.plugin plugins/list-plugin.plugin plugins/part-plugin.plugin plugins/privmsg-plugin.plugin plugins/user-plugin.plugin plugins/pong-plugin.plugin plugins/nick-plugin.plugin plugins/mode-plugin.plugin plugins/oper-plugin.plugin plugins/conreg-plugin.plugin plugins/topic-plugin.plugin plugins/example-service.service
